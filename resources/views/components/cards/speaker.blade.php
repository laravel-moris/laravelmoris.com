...
<a href="{{ route('members.show', $speaker->id) }}" class="block group lm-card lm-reveal rounded-3xl px-8 py-10 text-center group-hover:-translate-y-2 group-hover:border-teal" data-reveal>
