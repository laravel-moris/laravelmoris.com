...
@section('body')
    ...
    <section class="relative overflow-hidden py-16 md:py-24">
        ...
        <div class="relative z-10 px-6 md:px-12 max-w-4xl mx-auto text-center">
            <x-heading level="1" class="mb-6 opacity-0 animate-[lm-hero-title_1.2s_cubic-bezier(0.16,1,0.3,1)_forwards]">
    ...
    <main class="px-6 md:px-12 pb-16">
        <div class="max-w-5xl mx-auto flex flex-col gap-10">
            ...
            <x-card class="p-8 relative overflow-hidden group">
                {{-- Decorative Gradient Background --}}
                <div class="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-coral/5 opacity-50"></div>

                <div class="relative">
                    <div class="flex flex-col items-center text-center mb-12">
                        <x-heading level="2" class="mb-4">Meet the Team</x-heading>
                        <x-text size="md" class="text-lg max-w-2xl text-muted leading-relaxed">
                            ...
                            @foreach ($teamMembers as $member)
                                <x-card
                                    ...
                                    <a href="{{ route('members.show', $member) }}"
                                        ...
                                        <x-text size="md"
                                            class="font-bold group-hover/member:text-primary transition-colors">
                                            {{ $member->name }}
                                        </x-text>
                                        @if ($member->title)
                                            <x-text variant="muted"
                                                class="text-xs uppercase tracking-widest mt-1">{{ $member->title }}</x-text>
                                        @endif
                                    </a>
                                </x-card>
                            @endforeach
                    ...
                    @else
                        <div
                            ...
                            <x-text variant="muted" class="text-lg">Team members coming soon...</x-text>
                        </div>
                    @endif
                </div>
            </x-card>
            ...
            <x-card class="p-8 relative overflow-hidden group">
                <div class="relative">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <x-heading level="2" class="text-3xl">Overview</x-heading>
                    </div>

                    <x-text size="md" class="mb-8 text-lg leading-relaxed text-muted">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <x-badge color="primary" variant="soft" size="md">
                            Monthly Events
                        </x-badge>
                        <x-badge color="green" variant="soft" size="md">
                            Vibrant Community
                        </x-badge>
                        <x-badge color="gold" variant="soft" size="md">
                            Open Source
                        </x-badge>
                    </div>
                </div>
            ...
            <x-card class="p-8 relative overflow-hidden group">
                <div class="relative">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <x-heading level="2" class="text-3xl">Our Background</x-heading>
                    </div>

                    <x-text size="md" class="text-lg leading-relaxed text-muted">
            ...
            <x-card class="p-8 relative overflow-hidden group">
                <div class="relative">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <x-heading level="2" class="text-3xl">The Challenge</x-heading>
                    </div>
